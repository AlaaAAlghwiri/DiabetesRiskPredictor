...
### Prep data for machine learning models
```{r}
# prep binary columns
...
# Model Evaluation
## Compare the Cross-validation performance
...
In this stage, will pick the best 3 models and will fine-tune them to get the best hyperparameters.
...
importance_rf <- varImp(model.rf.finetuned)
